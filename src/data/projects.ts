export const projects = [
    ...
    {
        title: 'CI/CD PIPELINE FOR SENTIMENT ANALYZER',
        description: 'Automated CI/CD pipeline for a machine learning sentiment analysis web application.',
        details: '• Designed automated test and build workflows using Jenkins. • Containerized the Streamlit dashboard via Docker. • Configured webhook integrations for push-triggered builds on GitHub.',
        tech: ['Jenkins', 'Docker', 'Streamlit', 'GitHub', 'Python', 'Scikit-learn'],
