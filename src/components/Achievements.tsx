        ...
        <div className="grid md:grid-cols-2 gap-6">
          {achievements.map((achievement, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group relative bg-white border border-blue-900/20 rounded-[1.5rem] p-8 hover:border-blue-900/60 transition-all duration-300 overflow-hidden transform hover:scale-105 hover:-translate-y-2 animate-fade-in cursor-pointer shadow-xl hover:shadow-2xl"
