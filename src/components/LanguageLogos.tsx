...
const logos: Record<string, () => JSX.Element> = {
  ...
  'Forage | TATA': () => <GenericSkillLogo Icon={Building2} color="bg-orange-500" />,
  'Forage | Deloitte': () => <GenericSkillLogo Icon={Briefcase} color="bg-blue-600" />,
  'LinkedIn Learning': () => <div className="w-8 h-8 bg-[#0A66C2] rounded-lg flex items-center justify-center text-white font-bold text-xs shadow-md">in</div>,
  ...
  'NPTEL | IIT Madras': () => <GenericSkillLogo Icon={GraduationCap} color="bg-blue-600" />,
  'Xplore IT Corp': () => <GenericSkillLogo Icon={Globe} color="bg-orange-500" />,
  ...
  'Solutions Architecture Job Simulation': () => <GenericSkillLogo Icon={Cloud} color="bg-purple-600" />,
  'GenAI Powered Data Analytics Job Simulation': () => <GenericSkillLogo Icon={Brain} color="bg-orange-500" />,
  'Data Analytics Job Simulation': () => <GenericSkillLogo Icon={Briefcase} color="bg-blue-600" />,
  'Critical Thinking and Problem Solving': () => <GenericSkillLogo Icon={Brain} color="bg-blue-600" />,
  'Problem-Solving Techniques': () => <GenericSkillLogo Icon={Puzzle} color="bg-purple-600" />,
  'Python Machine Learning: From Beginner to Pro': () => <GenericSkillLogo Icon={Brain} color="bg-blue-600" />,
  'Python for Data Science': () => <GenericSkillLogo Icon={GraduationCap} color="bg-blue-600" />,
  'ChatGPT + Bing (Copilot): Prompt Engineering Masterclass': () => <GenericSkillLogo Icon={Terminal} color="bg-purple-600" />,
  'Full Stack Development with Python': () => <GenericSkillLogo Icon={Layout} color="bg-orange-500" />,
  'ReactJs - The Complete ReactJs Course For Beginners': () => <GenericSkillLogo Icon={Code2} color="bg-purple-600" />,
  'Django Full Stack Web Development with Python': () => <GenericSkillLogo Icon={Layout} color="bg-orange-500" />,
  'Create, Publish & Monetize GPTs on ChatGPT': () => <GenericSkillLogo Icon={MessageSquare} color="bg-blue-600" />,
  'MongoDB - The Complete MongoDB Developers Course': () => <GenericSkillLogo Icon={Database} color="bg-purple-600" />,
  'Python Pro: Essential Tips for Real-World Coding & Careers': () => <GenericSkillLogo Icon={Code2} color="bg-orange-500" />,
};
